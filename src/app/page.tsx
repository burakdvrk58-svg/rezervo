  ...
  return (
    <div className="relative min-h-screen bg-black text-slate-300 font-sans selection:bg-white/20 selection:text-white overflow-x-hidden">
      ...
      <section 
        ...
        className="relative pt-36 pb-24 md:pt-48 md:pb-32 z-10 max-w-7xl mx-auto px-6 overflow-hidden"
      >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center relative z-10">
          ...
          <div className="lg:col-span-7 space-y-8">
            <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-1.5 backdrop-blur-md">
              ...
              <span className="text-xs font-semibold text-slate-200">Yeni Nesil Akademik Rezervasyon Sistemi</span>
            </div>
