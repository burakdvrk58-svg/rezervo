...
const ROOM_PERFORMANCE = [
  { name: 'Deluxe Standart Oda', bookings: 68, revenue: '48.960 TL', occupancy: '%89' },
  { name: 'Kral Dairesi', bookings: 18, revenue: '41.400 TL', occupancy: '%62' },
  { name: 'Deniz Manzaralı Aile Odası', bookings: 42, revenue: '28.140 TL', occupancy: '%85' },
  { name: 'Standart Tek Kişilik Oda', bookings: 14, revenue: '9.950 TL', occupancy: '%78' }
]
    ...
    <div className="space-y-8 pb-12">
      ...
      <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
          ...
          <p className="mt-3 text-2xl font-black text-slate-900">128.450 TL</p>
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
          ...
          <p className="mt-3 text-2xl font-black text-slate-900">%84</p>
          <div className="mt-2 flex items-center gap-1 text-[11px] font-bold text-emerald-600">
            <ArrowUpRight className="h-3.5 w-3.5" />
            <span>%3.2</span>
            <span className="text-slate-400 font-semibold ml-0.5">geçen aya göre</span>
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
          ...
          <p className="mt-3 text-2xl font-black text-slate-900">142 Adet</p>
          <div className="mt-2 flex items-center gap-1 text-[11px] font-bold text-emerald-600">
            <ArrowUpRight className="h-3.5 w-3.5" />
            <span>%8.6</span>
            <span className="text-slate-400 font-semibold ml-0.5">geçen aya göre</span>
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
          ...
          <p className="mt-3 text-2xl font-black text-slate-900">904 TL</p>
        ...
        <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm space-y-6">
          ...
          <div className="relative flex items-center justify-center h-48">
            <svg className="w-36 h-36 transform -rotate-90" viewBox="0 0 36 36">
              ...
              {/* Direkt: 45% (Stroke-dasharray: 45 55, Offset: 0) */}
              <circle
                cx="18"
                cy="18"
                r="15.915"
              ...
              />
              {/* Rezervo Mobil: 35% (Stroke-dasharray: 35 65, Offset: -45) */}
              <circle
                cx="18"
                cy="18"
                r="15.915"
                ...
                className="transition-all duration-300 hover:stroke-[4.5px]"
              />
              {/* Acenteler: 20% (Stroke-dasharray: 20 80, Offset: -80) */}
              <circle
                cx="18"
                cy="18"
                r="15.915"
      ...
      <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm space-y-4">
        <h3 className="text-base font-black text-slate-900">Oda Tiplerine Göre Performans</h3>
          ...
          <table className="w-full text-left text-xs text-slate-500">
            <thead className="bg-slate-50 text-[10px] text-slate-400 font-extrabold uppercase tracking-wider">
              <tr>
                ...
                <th className="px-4 py-3 rounded-r-xl text-right">Elde Edilen Gelir</th>
              </tr>
            </thead>
